...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { label: "Telegram", href: "/dashboard/telegram", hint: "Settings", section: "settings", keywords: ["telegram", "bot", "token", "channel", "chat id", "goat channel"] },
  { label: "GOAT", href: "/dashboard/goat", hint: "Settings", section: "settings", keywords: ["goat", "filter", "industry", "category", "seniority", "vip", "blacklist"] },
