...
export interface LinkedInJob {
  ...
  domain: string;
  postedDate: string;
  postedTimeAgo: string; // e.g., "8 hours ago", "2 days ago"
  description: string;
  url: string;
  inputKeyword: string; // The search keyword that found this job
  companyUrl?: string;
  img?: string;
  earlyApplicant?: boolean; // "Be an early applicant" badge
  compensation?: string;
